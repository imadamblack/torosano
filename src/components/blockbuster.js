...
export default function Blockbuster({overhead, title, description, background, imgPos = 'object-center'}) {
  ...
  return (
    <section className={`relative flex flex-col justify-end aspect-[4/3] md:aspect-[3/1] w-screen md:mb-0 mx-auto pt-12 md:py-20 ${bg}`}>
      <div className="absolute inset-0 bg-gradient-to-tr from-brand-4 to-transparent opacity-40 z-10"/>
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-stretch">
          <div className="w-2/3 p-8 md:p-14">
            ...
            <h2
              ...
              className="my-auto ft-8 font-bold text-white [text-shadow:_1px_1px_0_rgb(0_0_0_/_30%)]"
            />
      ...
      {typeof background === 'object' &&
        <Image src={background} layout="fill" className={`object-cover ${imgPos}`}/>
      }
    </section>
  );
}